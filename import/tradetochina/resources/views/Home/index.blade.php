...
<div class="intro" style="background-image: url(web/images/bg3.jpg);">
    <div class="dtable hw100">
        <div class="dtable-cell hw100">
            <div class="container text-center">
                <h1 class="intro-title animated fadeInDown"> {{ trans('index.intro-title') }} </h1>

                <p class="sub animateme fittext3 animated fadeIn">  {{ trans('index.intro-sub') }} </p>
                ...
                <div class="inner-box relative">
                    ...
                    <div class="row">
                     ...
                     <span class="item-carousel-thumb">
                    	<img class="img-responsive" src="web/images/auto/2012-mercedes-benz-sls-amg.jpg" alt="img">
                     </span>
                                ...
                                <div class="item"><a href="ads-details.html">
                                        <span class="item-carousel-thumb"> <img class="item-img"
                                                                                src="web/images/item/tp/Image00006.jpg"
                                                                                alt="img"> </span>
                                ...
                                <div class="item"><a href="ads-details.html">
                                        <span class="item-carousel-thumb"> <img class="item-img"
                                                                                src="web/images/item/tp/Image00022.jpg"
                                                                                alt="img"> </span> <span
                                ...
                                <div class="item"><a href="ads-details.html">
                                        <span class="item-carousel-thumb"> <img class="item-img"
                                                                                src="web/images/item/tp/Image00013.jpg"
                                                                                alt="img">  </span><span
                                ...
                                <div class="item"><a href="ads-details.html">
                                        <span class="item-carousel-thumb"> <img class="item-img"
                                                                                src="web/images/item/FreeGreatPicture.com-46404-google-drops-nexus-4-by-100-offers-15-day-price-protection-refund.jpg"
                                                                                alt="img"> </span> <span
                                ...
                                <div class="item"><a href="ads-details.html">
                                        <span class="item-carousel-thumb"> <img class="item-img"
                                                                                src="web/images/item/FreeGreatPicture.com-46405-google-drops-price-of-nexus-4-smartphone.jpg"
                                                                                alt="img"> </span> <span
                                ...
                                <div class="item"><a href="ads-details.html">
                                        <span class="item-carousel-thumb"> <img class="item-img"
                                                                                src="web/images/item/FreeGreatPicture.com-46407-nexus-4-starts-at-199.jpg"
                                                                                alt="img"> </span> <span
                ...
                <aside>
                    <div class="inner-box no-padding">
                        <div class="inner-box-content"><a href="#"><img class="img-responsive"
                                                                        src="web/images/site/app.jpg" alt="tv"></a>
                        </div>
                    </div>
                    <div class="inner-box">
...
<div class="page-info hasOverly" style="background: url(web/images/bg.jpg); background-size:cover">
    <div class="bg-overly ">
